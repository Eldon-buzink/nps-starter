      ...
      <div className="rounded-lg border bg-card text-card-foreground shadow-sm">
        <div className="p-6">
          ...
          <p className="text-sm text-muted-foreground mt-2">
            {coverage?.with_comments || 0} van {coverage?.total_responses || 0} reacties hebben opmerkingen 
            ({coverage?.total_responses ? Math.round(((coverage.with_comments || 0) / coverage.total_responses) * 100) : 0}%)
          </p>
        </div>
      </div>
    </div>
