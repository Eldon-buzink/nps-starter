-- Fix theme classification issues
-- This script addresses the "Other (cluster)" being too large

-- First, let's refresh the views to pick up any new synonyms
drop view if exists v_theme_assignments_normalized;
drop view if exists v_theme_overview_normalized;
...
-- Debug: Show current theme distribution
select 
  theme, 
  mentions,
