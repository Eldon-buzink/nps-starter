-- Clean Database Setup - Handles existing objects
...
DROP FUNCTION IF EXISTS similar_responses_by_vector(vector, int) CASCADE;
...
CREATE TABLE nps_ai_enrichment (
    ...
    embedded_vector TEXT, -- For semantic search (JSON array as text until pgvector is enabled)
